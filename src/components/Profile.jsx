    ...
    return (
        <div className="flex flex-row capitalize">
            ...
            <div className="w-3/4 relative bg-slate-200">
                ...
                <div className=" bg-white rounded-2xl w-[25%] h-[50%] max-h-[500px] absolute z-40 top-24 left-8 text-center">
                ...
                <div className="flex flex-col w-[70%] ml-auto">
                    <nav className="flex flex-row justify-between w-full p-2">
                        ...
                        <div className="p-2 flex flex-row gap-2 basis-1/2">
                            <button className=" border-none bg-purple-700 text-white rounded p-2 w-[50%]">add post</button>
                            <button className=" border-purple-700 text-purple-700 rounded p-2 w-[50%]">edit profile</button>
                        </div>
                    </nav>
